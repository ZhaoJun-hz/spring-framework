...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			// 准备刷新的上下文环境，该方法主要是做些准备工作，例如对系统属性及环境变量的初始化及验证
			prepareRefresh();

			// Tell the subclass to refresh the internal bean factory.
			// 初始化BeanFactory，并进行XML文件读取
			// ApplicationContext包含BeanFactory的所有功能，而且在其基础上添加了大量的扩展应用，obtainFreshBeanFactory正是实现BeanFactory的地方，
			// 经过了这个函数后，ApplicationContext就已经有了BeanFactory的全部功能
	...
	protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		...
		// 添加BeanPostProcess
		// 注册ApplicationContextAwareProcessor这个BeanPostProcess，关心其postProcessBeforeInitialization和postProcessAfterInitialization两个方法
	...
	protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
		// 调用PostProcessorRegistrationDelegate类的invokeBeanFactoryPostProcessors方法
